window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var styles = {
			...
			row: "u_row", keyLabel: "u_keyLabel", keyInput: "u_keyInput", num: "u_num", dir: "u_dir", hint: "u_hint",
