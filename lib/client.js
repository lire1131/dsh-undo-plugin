window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var styles = {
			...
			save: "u_save", close: "u_close", diffbox: "u_diffbox", diffhead: "u_diffhead", difffile: "u_difffile", diffadd: "u_diffadd", diffdel: "u_diffdel"
		};
		//#endregion
		//#region locales
		const NS = "undo";
		const zh = {
			...
			"boot.alert": "⚠️ 检测到上次 DSH 异常退出,建议「撤销」回退到上次正常状态",
		...
		const en = {
			...
			"boot.alert": "⚠️ Previous DSH run exited abnormally — consider Undo to roll back to the last good state",
				...
				children: (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)("div", {
							...
							children: [
								bootAlert && (0, react_jsx_runtime.jsx)("span", { className: styles.msg + " " + styles.err, children: t("boot.alert") }),
								msg !== null && (0, react_jsx_runtime.jsx)("span", {
									className: styles.msg + " " + (msgOk ? styles.ok : styles.err),
									children: msg
								}),
