window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var styles = { actions: "u_actions", btn: "u_btn", msg: "u_msg", ok: "u_ok", err: "u_err", row: "u_row", keyLabel: "u_keyLabel", keyInput: "u_keyInput", hint: "u_hint" };
		//#endregion
		//#region locales
		const NS = "undo";
		const zh = {
